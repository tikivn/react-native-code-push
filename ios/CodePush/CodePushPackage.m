...
{
    NSString* codePushPath = [[CodePush getApplicationSupportDirectory] stringByAppendingPathComponent:[CodePushConfig current].deploymentKey];
    codePushPath = [codePushPath stringByAppendingPathComponent:@"CodePush"];
